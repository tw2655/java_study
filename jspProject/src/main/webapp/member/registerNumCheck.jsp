...
<div class="layer_fix layer_unfix pop_login pop_mem_reserve new-style-form">
    <section>
        <form id="loginForm" action="${root }/member/registerNumCheckService.jsp" autocomplete="off" method="post" novalidate="novalidate">
            <input type="hidden" name="returnUrl" value="">
            <input type="hidden" name="yeogi_token" value="8c1ed6e1cf02fe6eba7ebf5a8b561e35">

            <strong class="sub_title">인증 번호</strong>
            <p class="txt_top">
                인증 번호를 입력해 주세요.
            </p>
            ...
            <div class="inp_type_1 ico_email form-errors"><!-- focus / err -->
                <input type="text" name="number" placeholder="인증 번호" required="" class="required" value="" data-msg-required="이메일 주소를 확인해 주세요.">
