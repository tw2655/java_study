...
<div class="layer_fix layer_unfix pop_login pop_mem_reserve new-style-form">
    <section>
        <form id="loginForm" action="${root }/member/registerSendMail.jsp" autocomplete="off" method="post" novalidate="novalidate">
            ...
            <button type="submit" data-js-validate-email="" id="mail_btn" class="btn_link gra_left_right_red"><span>확인</span></button>
            <script>
            	$(function(){
