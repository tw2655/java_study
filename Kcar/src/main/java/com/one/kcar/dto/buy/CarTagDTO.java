...
public class CarTagDTO {
	...
	public CarTagDTO() {
		this.brandCarInfoTag = new ArrayList<>();
	}
	...
	public void setC_num(String c_num) {
		if (c_num != null)
			this.brandCarInfoTag.add(c_num);
	...
	public void setC_t_certified(String c_t_certified) {
		if (c_t_certified != null)
			this.brandCarInfoTag.add(c_t_certified);
	...
	public void setC_t_distance(String c_t_distance) {
		if (c_t_distance != null)
			this.brandCarInfoTag.add(c_t_distance);
	...
	public void setC_t_newCar(String c_t_newCar) {
		if (c_t_newCar != null)
			this.brandCarInfoTag.add(c_t_newCar);
	...
	public void setC_t_fourWheel(String c_t_fourWheel) {
		if (c_t_fourWheel != null)
			this.brandCarInfoTag.add(c_t_fourWheel);
	...
	public void setC_t_maintenance(String c_t_maintenance) {
		if (c_t_maintenance != null)
			this.brandCarInfoTag.add(c_t_maintenance);
	...
	public void setC_t_oneOwner(String c_t_oneOwner) {
		if (c_t_oneOwner != null)
			this.brandCarInfoTag.add(c_t_oneOwner);
	...
	public void setC_t_specialOption(String c_t_specialOption) {
		if (c_t_specialOption != null)
			this.brandCarInfoTag.add(c_t_specialOption);
	...
	public void setC_t_rent(String c_t_rent) {
		if (c_t_rent != null)
			this.brandCarInfoTag.add(c_t_rent);
