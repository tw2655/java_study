...
<link rel="preload" href="/_nuxt/9f4dabe.js" as="script">
<link rel="preload" href="/_nuxt/cc53266.js" as="script">
<link rel="preload" href="/_nuxt/be601ca.js" as="script">
<link rel="preload" href="/_nuxt/eeabe6b.js" as="script">
<link rel="preload" href="/_nuxt/5c1d476.js" as="script">
...
<meta data-n-head="ssr" data-hid="title" name="title" content="일반정비소">
</head>
<body>
	...
	<div id="__nuxt">
		...
		<div id="__layout">
			<div id="app" class="Container">
				...
				<div data-v-1e88d8ab="" class="rentArea rentWrap contWrap">
					<div data-v-1e88d8ab="" class="hsBanner keyVisual4">
						<p data-v-1e88d8ab="" class="title">렌트일반정비소</p>
						<p data-v-1e88d8ab="" class="desc">
							일반 수리 및 차량 점검, 소모품교환이 필요할 때 <br data-v-1e88d8ab="">가까운
							렌트일반정비소를 방문해 서비스를 이용해보세요
						</p>
					</div>
					<div data-v-1e88d8ab="" class="repairShop">
						<div data-v-1e88d8ab="" class="el-row">
							<div data-v-1e88d8ab="" class="subHeader pt64">
								<h1 data-v-1e88d8ab="" class="title">렌트 일반정비소 안내</h1>
								<p data-v-1e88d8ab="" class="desc">K Car 렌트와 제휴된 전국 일반정비소를
									확인하실 수 있습니다</p>
							</div>
						</div>
						...
						<table style="width: 1150px;">
							...
							<c:forEach var="db" items="${rnrList }">
								<tr>
									<td style="width: 100px; height: 40px;" align="center">${db.crn_location }</td>
									<td style="width: 300px; height: 40px;" align="left">${db.crn_name }</td>
									<td style="width: 200px; height: 40px;" align="left">${db.crn_tel }</td>
									<td style="width: 550px; height: 40px;" align="left">${db.crn_addr }</td>
								</tr>
							</c:forEach>
							<tr>
								<td colspan=4><hr /></td>
							...
							<ul data-v-1e88d8ab="" class="guideTxt mT16">
								<li data-v-1e88d8ab="">K Car 전국직영점 및 KW 정비소와는 무관하며 K Car
									렌트를 통해 직접 운영됩니다</li>
								<li data-v-1e88d8ab="">사고수리의 경우 정비 부서의 안내를(1855-0052) 받아 입고
									부탁드립니다</li>
							</ul>
						</div>
						<div data-v-1e88d8ab="" class="el-row">
							<div data-v-1e88d8ab="" class="repairShopArea">
								<ul data-v-1e88d8ab="" class="shopLists">
									<li data-v-1e88d8ab=""><a data-v-1e88d8ab=""
										href="rentShop"><div data-v-1e88d8ab="">
												<strong data-v-1e88d8ab=""> 렌트지점 </strong>
												<p data-v-1e88d8ab="">
													신차에서 중고차까지 <br data-v-1e88d8ab="">렌트 전문 지점에서 최상의 서비스를
													만나보세요
												</p>
											</div></a></li>
									<li data-v-1e88d8ab=""><a data-v-1e88d8ab=""
										href="rentAccidentRepair"><div data-v-1e88d8ab="">
												<strong data-v-1e88d8ab=""> 렌트사고정비소 </strong>
												<p data-v-1e88d8ab="">
													24시간 사고·고장 발생 시 접수부터 수리까지 신속하고 편리하게! <br data-v-1e88d8ab="">전국
													언제 어디서나 믿고 이용할 수 있는 사고수리정비서비스
												</p>
											</div></a></li>
								</ul>
							</div>
	...
	<div id="criteo-tags-div" style="display: none;">
		<script async="true" type="text/javascript"
			src="https://sslwidget.criteo.com/event?a=73896&amp;v=5.12.0&amp;p0=e%3Dexd%26site_type%3Dd&amp;p1=e%3Dvh&amp;p2=e%3Ddis&amp;adce=1&amp;bundle=B8QDr19BaHRsbVhvSk1jUVRCU0hFa1ZBTncwb0swdUwxcnB0OU5QaElFekQzbyUyRjVCZTY3TTclMkIyNkZjUHVZOXB0d0VGMVBSbGNZOGN4T3BpWFQ5WGM4cXBpQ2VFeGNFQnhOT3Iyb1FGNHNiQXJ1UkxCbkxmayUyQk9GQW9OVEJyVFdleWNSUg&amp;tld=kcar.com&amp;fu=https%253A%252F%252Fwww.kcar.com%252Fur%252FRentGnrlCenter&amp;pu=https%253A%252F%252Fwww.kcar.com%252Fbc%252Fsearch&amp;dtycbr=90790"></script>
	</div>
	<script type="text/javascript" id=""
		src="//static.criteo.net/js/ld/ld.js"></script>
	<script type="text/javascript" id="">!function(b,e,f,g,a,c,d){b.fbq||(a=b.fbq=function(){a.callMethod?a.callMethod.apply(a,arguments):a.queue.push(arguments)},b._fbq||(b._fbq=a),a.push=a,a.loaded=!0,a.version="2.0",a.queue=[],c=e.createElement(f),c.async=!0,c.src=g,d=e.getElementsByTagName(f)[0],d.parentNode.insertBefore(c,d))}(window,document,"script","https://connect.facebook.net/en_US/fbevents.js");fbq("init","771045850193577");fbq("track","PageView");</script>
	...
	<script type="text/javascript" id=""
		src="//static.criteo.net/js/ld/ld.js"></script>
	<script type="text/javascript" id="">var searchurl=google_tag_manager["GTM-NXZPHVG"].macro(26),number=searchurl.indexOf("i_sCarCd\x3d"),carid=searchurl.substr(number+9,10),carprice=$("#carPrice").text().replace("\uc6d0","").replace(/,/gi,"");gtag("event","view_item",{send_to:"G-12BKR6ZT1H",currency:"KRW",items:[{item_id:google_tag_manager["GTM-NXZPHVG"].macro(28),price:google_tag_manager["GTM-NXZPHVG"].macro(30),currency:"KRW",quantity:1}]});</script>
	<script type="text/javascript" id="">window.dataLayer=window.dataLayer||[];function gtag(){dataLayer.push(arguments)}gtag("js",new Date);gtag("config","AW-938190343");var searchurl=google_tag_manager["GTM-NXZPHVG"].macro(20),number=searchurl.indexOf("i_sCarCd\x3d"),carid=searchurl.substr(number+9,10);gtag("event","view_item",{send_to:"AW-938190343",items:[{id:google_tag_manager["GTM-NXZPHVG"].macro(22),google_business_vertical:"retail"}]});</script>
	<script type="text/javascript" id="">var searchurl=google_tag_manager["GTM-NXZPHVG"].macro(23),number=searchurl.indexOf("i_sCarCd\x3d"),carid=searchurl.substr(number+9,10);window.criteo_q=window.criteo_q||[];var deviceType=/iPad/.test(navigator.userAgent)?"t":/Mobile|iP(hone|od)|Android|BlackBerry|IEMobile|Silk/.test(navigator.userAgent)?"m":"d";window.criteo_q.push({event:"setAccount",account:73896},{event:"setSiteType",type:deviceType},{event:"viewItem",item:google_tag_manager["GTM-NXZPHVG"].macro(25)});</script>
	<iframe height="0" width="0" title="Criteo DIS iframe"
		style="display: none;"></iframe>
	...
	<div class="el-menu--horizontal gnbSubMenu typeCenter1"
		style="position: absolute; top: 104px; left: 383px; z-index: 2030; display: none;"
		...
		<ul role="menu"
			...
			<li role="menuitem" tabindex="-1"
				class="el-menu-item menuItem is-active">렌트일반정비소</li>
			<li role="menuitem" tabindex="-1" class="el-menu-item menuItem">
				렌트사고정비소</li>
		</ul>
	</div>
	<iframe height="0" width="0" title="Criteo DIS iframe"
		style="display: none;"></iframe>
	<div class="el-menu--horizontal gnbSubMenu typeCenter1"
		style="position: absolute; top: 106px; left: 190px; z-index: 2008; display: none;"
		x-placement="bottom-start">
		<ul role="menu"
			class="el-menu el-menu--popup el-menu--popup-bottom-start">
			<div class="menuTitArea">
	...
	<div class="el-menu--horizontal gnbSubMenu typeCenter1"
		style="position: absolute; top: 106px; left: 286px; z-index: 2011; display: none;"
		x-placement="bottom-start">
		<ul role="menu"
			class="el-menu el-menu--popup el-menu--popup-bottom-start">
			<div class="menuTitArea">
	...
	<div class="el-menu--horizontal gnbSubMenu typeCenter1"
		style="position: absolute; top: 106px; left: 447px; z-index: 2014; display: none;"
		x-placement="bottom-start">
		<ul role="menu"
			class="el-menu el-menu--popup el-menu--popup-bottom-start">
			<div class="menuTitArea">
