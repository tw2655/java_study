									...
									<div class="boardViewTitle">
										<table style="width: 100%;">
											<tr>
												...
												<td><input type="text" autocomplete="off" maxlength="30" placeholder="제목 입력" class="el-input__inner" id="title" name="n_title" value="${modifyList.n_title }"></td>
											</tr>
											<tr style="height: 20px;"></tr>
											<tr>
												<td style="width: 150px; text-align: center;">내용</td>
												<td><textarea autocomplete="off" rows="2" placeholder="내용 입력" class="el-textarea__inner" id="content" name="n_content" style="resize: none; min-height: 173px; height: 350px;">${modifyList.n_content }</textarea></td>
											</tr>
										</table>
									</div>
								</div>
